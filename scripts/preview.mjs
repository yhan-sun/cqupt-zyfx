...
const names = ['index.html','news.html','sources.html','404.html','news/marathon-2026.html','news/marathon-2025.html','news/marathon-2024.html'];
const pages = {};
...
console.log(`Wrote standalone seven-page preview: ${output}`);
