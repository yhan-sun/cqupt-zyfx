...
console.log(`Built ${new Set([...pages.keys(), ...officialPages, ...joinPages, ...structurePages]).size} pages with 20 self-flying official-account photographs, culture-led event archive, standalone running gallery, motion-safe reveals, click-to-enlarge running photography, science hub and verified QQ join experience${offline ? ' from the offline source cache' : ''}.`);
