...
console.log(`Built ${new Set(allPages).size} pages with a standalone association story, nine association-supplied photographs, 20 official-account photographs, culture-led event archive, 35-photo running gallery, motion-safe reveals, science hub and verified QQ join experience${offline ? ' from the offline source cache' : ''}.`);
