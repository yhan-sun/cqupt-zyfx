...
console.log(`Built ${new Set([...pages.keys(), ...officialPages, ...joinPages, ...structurePages]).size} pages with merged events, standalone running gallery, source-verified official archive and verified QQ join experience${offline ? ' from the offline source cache' : ''}.`);
