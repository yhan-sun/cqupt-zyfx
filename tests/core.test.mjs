...
test('thirteen media entries carry individual provenance and rights', () => {
  assert.equal(media.length,13);
  assert.equal(new Set(media.map(i=>i.id)).size,13);
...
test('all seven static pages and article source captions are rendered', () => {
